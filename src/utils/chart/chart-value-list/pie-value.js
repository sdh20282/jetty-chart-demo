...
const DEFAULT_LEGEND_USE = true;
const DEFAULT_LEGEND_POSITION = "center-center";
const DEFAULT_LEGEND_X_LOCATION = 0;
const DEFAULT_LEGEND_Y_LOCATION = 0;
const DEFAULT_LEGEND_DIRECTION_COLUMN = true;
const DEFAULT_LEGEND_ITEM_WIDTH = 0.3;
const DEFAULT_LEGEND_ITEM_MARGIN = 0.03;
const DEFAULT_LEGEND_SYMBOL_SIZE = 0.1;
const DEFAULT_LEGEND_SYMBOL_RADIUS = 3;
const DEFAULT_LEGEND_SYMBOL_MARGIN = 0.1;
const DEFAULT_LEGEND_SYMBOL_OPACITY = 1;
const DEFAULT_LEGEND_SIZE = 0.1;
const DEFAULT_LEGEND_WEIGHT = 400;
const DEFAULT_LEGEND_OPACITY = 1;
const DEFAULT_LEGEND_COLOR = "#aaa";
const DEFAULT_LEGEND_ON_START = true;
