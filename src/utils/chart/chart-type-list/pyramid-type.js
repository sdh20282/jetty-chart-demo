export const pyramidType = {
  base: [
    {
      name: "data",
      attribute: "object[],required",
      description: "차트의 데이터를 의미합니다. { id:string, arr:[{value:int, label:string}] } 형태로 입력해야 합니다. (value는 모두 양수 이거나 모두 음수여야 하며, label은 keys의 각 값과 동일(ex. '남', '여'))",
      type: "description",
    },
    {
      name: "yLegend",
  ...
  normalSettings: [
    ...
    },
    {
      ...
      description : "데이터의 방향을 변경합니다.",
      type : "boolean"
    },
    {
      name : "yReverse",
      attribute : "boolean,optional",
      description : "데이터의 값 축을 반대로 배치합니다.",
      type : "boolean"
    },
  ],
  scopeSettings: [
