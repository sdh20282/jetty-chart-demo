export const StackedBarType = {
  ...
  normalSettings: [
    ...
    },
    {
      name: "reverseOrder",
      attribute: "boolean,optional",
      description: "차트 순서를 뒤집을지를 의미합니다.",
      type: "boolean",
    },
  ],
  scopeSettings: [
  ...
  animationSettings: {
    barSettings: [
      ...
      },
      {
        ...
        attribute: "number,optional",
        description: "bar 시작 애니메이션에서 하나하나의 바에 대한 대기 시간을 의미합니다.",
        type: "number",
        unit: "s",
        dependency: "animationSettings-barSettings-useAnimation",
        show: true,
      },
      {
        ...
        attribute: "string,optional",
        description: "bar 시작 애니메이션 함수를 의미합니다.",
        type: "select",
        candidate: ["linear", "ease", "ease-in", "ease-out"],
        dependency: "animationSettings-barSettings-useAnimation",
        show: true,
      },
      {
        ...
        attribute: "string,optional",
        description: "bar 시작 애니메이션 시작 위치를 의미합니다.",
        type: "select",
      ...
      },
      {
        name: "textRender",
        attribute: "boolean,optional",
        description: "텍스트 렌더링 애니메이션 사용 여부를 의미합니다.",
        type: "boolean",
        dependency: "animationSettings-barSettings-useAnimation",
        show: true,
      },
      {
        name: "textRenderType",
        attribute: "string,optional",
        description: "텍스트 렌더링 애니메이션 타입을 의미합니다.",
        type: "select",
        candidate: ["grow", "grow-async", "fade"],
        dependency: ["animationSettings-barSettings-useAnimation", "animationSettings-barSettings-textRender"],
        show: [true, true],
      },
      {
        name: "textRenderDuration",
        attribute: "number,optional",
        description: "텍스트 렌더링 애니메이션 기간을 의미합니다.",
        type: "number",
        unit: "s",
        dependency: ["animationSettings-barSettings-useAnimation", "animationSettings-barSettings-textRender"],
        show: [true, true],
      ...
      {
        name: "textRenderStartDelay",
        attribute: "number,optional",
        description: "텍스트 렌더링 애니메이션 대기 시간을 의미합니다.",
        type: "number",
        unit: "s",
        dependency: ["animationSettings-barSettings-useAnimation", "animationSettings-barSettings-textRender"],
        show: [true, true],
      ...
      {
        name: "textRenderItemDelay",
        attribute: "number,optional",
        description: "텍스트 렌더링 애니메이션에서 하나하나의 바에 대한 대기 시간을 의미합니다.",
        type: "number",
        unit: "s",
        dependency: ["animationSettings-barSettings-useAnimation", "animationSettings-barSettings-textRender"],
        show: [true, true],
      ...
      {
        name: "textRenderTimingFunction",
        attribute: "string,optional",
        description: "텍스트 렌더링 애니메이션  함수를 의미합니다.",
        type: "select",
        candidate: ["linear", "ease", "ease-in", "ease-out"],
        dependency: ["animationSettings-barSettings-useAnimation", "animationSettings-barSettings-textRender"],
        show: [true, true],
      ...
      {
        name: "textRenderStartFrom",
        attribute: "string,optional",
        description: "텍스트 렌더링 애니메이션 시작 위치를 의미합니다.",
        type: "select",
        candidate: ["left", "right"],
        dependency: ["animationSettings-barSettings-useAnimation", "animationSettings-barSettings-textRender"],
        show: [true, true],
      ...
      },
      {
        ...
        attribute: "number,optional",
        description: "이동 애니메이션 기간을 의미합니다.",
        type: "number",
        unit: "s",
        dependency: ["animationSettings-barSettings-useAnimation", "animationSettings-barSettings-translateBar"],
        show: [true, true],
      },
      {
        name: "translateStartDelay",
        attribute: "number,optional",
        description: "이동 애니메이션 대기 시간을 의미합니다.",
        type: "number",
        unit: "s",
        dependency: ["animationSettings-barSettings-useAnimation", "animationSettings-barSettings-translateBar"],
        show: [true, true],
      },
      {
        ...
        attribute: "number,optional",
        description: "이동 애니메이션에서 하나하나의 바에 대한 대기 시간을 의미합니다.",
        type: "number",
        unit: "s",
        dependency: ["animationSettings-barSettings-useAnimation", "animationSettings-barSettings-translateBar"],
        show: [true, true],
      },
      {
        ...
        attribute: "string,optional",
        description: "이동 애니메이션  함수를 의미합니다.",
        type: "select",
        candidate: ["linear", "ease", "ease-in", "ease-out"],
        dependency: ["animationSettings-barSettings-useAnimation", "animationSettings-barSettings-translateBar"],
        show: [true, true],
